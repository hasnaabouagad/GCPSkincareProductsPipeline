...
pyspark_job = {
    "reference": {"project_id": "spheric-entity-457510-t4"},
    "placement": {"cluster_name": "skincare-dataproc-cluster"},
    "pyspark_job": {
        "main_python_file_uri": "gs://skin-care-pipeline-spheric-entity-457510-t4/spark/Spark_Processing.py",
    },
}
...
def skincare():
    ...
    upload_products = LocalFilesystemToGCSOperator(
        ...
        bucket='skin-care-pipeline-spheric-entity-457510-t4',
        gcp_conn_id='gcp',
        mime_type='text/csv',
    ...
    upload_spark_job = LocalFilesystemToGCSOperator(
        ...
        src="/usr/local/airflow/include/dataset/Spark_Processing.py",
    ...
    job=pyspark_job,
    region="europe-west1",
    project_id="spheric-entity-457510-t4",
    gcp_conn_id="gcp",
)
